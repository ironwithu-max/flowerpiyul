...
.result { margin-top:14px; padding:18px; border-radius:10px; text-align:center; background:#fdf2f8; border:1px solid #a7f3d0; }
.result-label { font-size:15px; font-weight:800; color:#9d174d; margin-bottom:8px; }
.result-desc { font-size:13px; color:#be185d; line-height:1.6; }
